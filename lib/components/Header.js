...
const Header = (props) => {
    ...
    const renderBody = (hasLeftButton, hasRightButton, hasTitle) => {
        ...
        <Label_1.default bold style={[(0, styles_1.TextSize)(24), react_native_1.StyleSheet.flatten(props.styles?.titleStyle)]}>
          {props.title || ""}
        </Label_1.default>
      </Flex_1.default>) : (<Spacer_1.default />);
        return (<Flex_1.default fill direction={"row"} style={[
                styles_1.RowCenter,
                default_values_1.default.HeaderHorizontalPadding,
