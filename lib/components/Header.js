...
const Header = (props) => {
    ...
    const renderBody = (hasLeftButton, hasRightButton, hasTitle) => {
        const _middleComponent = hasTitle ? (<Flex_1.default noPadding childrenPosition="MIDDLE" fill direction={"row"}>
        <Label_1.default>{props.title || ""}</Label_1.default>
      </Flex_1.default>) : (<Spacer_1.default />);
        return (<Flex_1.default fill direction={"row"}>
