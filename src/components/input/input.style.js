...
const inputStyle = (props) => {
    ...
    return StyleSheet.create({
        root: {
            ...
            margin: ThemeSystem.margin[props.marginSize || defaultTheme.inputMarginSize],
        },
        rootLabelled: {
            padding: ThemeSystem.padding[defaultTheme.inputPaddingSize],
            minWidth: defaultTheme.inputMinWidth,
        ...
        wrapper: {
            ...
            borderWidth: props.borderStyle?.borderWidth || defaultTheme.inputBorderWidth,
            borderColor: props.borderStyle?.borderColor || defaultTheme.inputBorderColor,
