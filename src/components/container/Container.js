    ...
    render() {
        ...
        if (safeAreaFlag) {
            if (this.props.gradientColors && this.props.gradientColors.length > 1) {
                return (<LinearGradient colors={this.props.gradientColors} style={_style.root}>
            <SafeAreaView style={[_style.safeArea]}>
              {headerComponent && (<View style={_style.headerContainer}>{headerComponent}</View>)}
              <View style={_style.container}>{children}</View>
            </SafeAreaView>
          </LinearGradient>);
            }
            return (<View style={_style.root}>
          <SafeAreaView style={[_style.safeArea]}>
            {headerComponent && (<View style={_style.headerContainer}>{headerComponent}</View>)}
            <View style={_style.container}>{children}</View>
          </SafeAreaView>
